...
;; For each package, define a function magnars-multiple-cursors/init-<package-multiple-cursors>
(defun magnars-multiple-cursors/init-multiple-cursors ()
  ...
  (use-package multiple-cursors
    ...
    (progn
      ...
      (bind-keys :map mc/keymap
           ("M-y" . yank-pop))
      (magnars-multiple-cursors/enable-compat))))

(defun magnars-multiple-cursors/post-init-multiple-cursors ()
  (use-package multiple-cursors
    :defer t
    :init
    (bind-keys
     ("M-m" . magnars-multiple-cursors/expand-or-mark-next-symbol)
     ("M-M" . magnars-multiple-cursors/expand-or-mark-next-word)
     ("M-'" . mc/mark-all-dwim)
     ("C-S-n" . mc/mmlte--down)
     ("C-S-p" . mc/mmlte--up)
...
(defun magnars-multiple-cursors/post-init-expand-region ()
